			    ...
			    for (i1=0; i1<str1.length; i1++){	
					  ...
					  for (i=1;i<ye;i++){
							  if (str.match('_img_')) {
								 ...
								 c='<a target="_blank" href="img.php?v=pic/'+str2+'"><img src="ui/ui_pic/transparent.gif" style="background-image:url(pic/'+str2+')"/></a>';var djtp='<span style="color:black">(点击图片看大图)</span><br>';
							  } 
							  else{
