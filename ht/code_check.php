...
{
echo '<meta name="viewport" content="width=device-width, user-scalable=yes, initial-scale=1.0, maximum-scale=1.5, minimum-scale=1.0" /><meta charset="utf-8" /><body style="background: #E5E4DB;"><div style="top:40%;left:0;position:absolute;width:100%;text-align:center"><img src="../ui/ui_pic/logo1.png" />错误啦!黑客们，我只是小网站，手下留情哦。。。<script language="javascript">setTimeout('.$dyh.'window.location.href="../index.php"'.$dyh.',2000);</script></div></body>';exit;
}
