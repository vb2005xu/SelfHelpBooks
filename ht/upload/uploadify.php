...
move_uploaded_file($tempFile,$targetFile);
 ...
 sleep(2);
 echo '<a target="_blank" href="img.php?v=pic/'.$wenjian1.'"><img src="ui/ui_pic/transparent.gif" style="background-image:url(pic/'.$wenjian1.')"/><input id="upload_pic" name="upload_pic" type="hidden" value="'.$wenjian1.'"  /></a>';
 exit;
}
else {
...
function getWidth($image) {
	...
	if (in_array($fileParts['extension'],$fileTypes)) {
        ...
        sleep(2);
		echo '<a target="_blank" href="img.php?v=pic/'.$wenjian.'"><img src="ui/ui_pic/transparent.gif" style="background-image:url(pic/'.$wenjian.')"/><input id="upload_pic" name="upload_pic" type="hidden" value="'.$wenjian.'"  /></a>';
	} else {
		echo '格式不对';
	}
}
