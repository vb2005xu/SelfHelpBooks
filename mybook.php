...
function paiban_i() {
		...
		n=Math.ceil(s/654);		
		if (str1.length==0*1){ $(".fengdi").before('<div class="eva-wz"><p>我还木有写文章呢，去写，或者转藏吧！</p></div>');}else{		
       for (i1=0; i1<str1.length; i1++)
{		wzid=wzid1[i1];
		yc=yc1[i1];
		str=str1[i1]; 
		if (str.match('_img_') || yc != '原创'){xiugai='';} else {xiugai='<span class="xiugai"><a href="xiugai.php?wzid='+wzid+'" >修改</a></span>';}
