...
","", $row[4])."'; ";			
	...
	function paiban_p() {
			...
			for (i1=0; i1<str1.length; i1++){		
					...
					if (str.match('_img_')) {
						zl='<div class="eva-zl"><span style="color:black">(点击图片看大图)</span><br><br><span style="color:black">热门相片来自</span><span class="yuanc"><a href="book.php?id='+userid+'">《'+fm_name+'》</a></span></div>';	var str2=str.replace(/_img_/, "");c=addtime+'<p>'+'<a target="_blank" href="img.php?v=pic/'+str2+'"><img src="ui/ui_pic/transparent.gif" style="background-image:url(pic/'+str2+')"/></a>'+zl+'</p>';
					} else {
						zl='<div class="eva-zl"><span class="yuanc"><a href="book.php?id='+userid+'">翻阅《'+fm_name+'》</a></span></div>';	c='<div class="eva-book"><div style="width:90%;margin:5%;"><a href="book.php?id='+userid+'"><img src="ui/ui_pic/transparent.gif"  style="background-image:url(fm_pic/'+fm_pic+');" /></a></div><div><h3><a style="cursor:default">&nbsp;&nbsp;&nbsp;</a></h3><h1><a href="book.php?id='+userid+'">'+fm_name+'('+bu+')</a></h1><h3>作者:'+name+'</h3><h3>订阅数:'+dy_count+'</h3></div></div>'+addtime+'<p>“ '+str.slice(0,n)+'....”'+zl+'</p>';
					}
	...
	$(".b-wrap-right").prepend('<h3 class="eva-top"><a href="index.php">今日目录</a></h3>');	
