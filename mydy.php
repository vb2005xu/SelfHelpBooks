...
$(function () {
		...
		function paiban_p() {
			if (fm_name1.length==0*1){
						$(".fengdi").before('<div class="eva-wz"><h3>还木有订阅某人呢。。。。。</h3></div>');
			}else {
				  for (i1=0; i1<fm_name1.length; i1++){
						  if (i1==(fm_name1.length-1) ){ 
							  bu2='<br><br><div style="width:100%;text-align:center"><span class="yuanc" ><a href="mydy.php?=<?php echo '&bu='.($bu1-1); ?>" >>>>>>更多>>>>></a></span><div>';
						  } else{ 
							  bu2='';
						  }			
