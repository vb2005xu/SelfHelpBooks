...
<div style=" text-align:center;position:absolute;top:3%;width:100%;height:5%;z-index:9;text-align:center">
    <form style="font-size:14px; font-weight: bold;" action="s.php" method="get"  target="_self" >封面名:&nbsp;<input name="keyword" type="text" style="width:200px;height:20px;font-size:12px;border:1px solid #aaa;padding:2px" value="<?php echo $keyword;?>"/>
    <button>搜索</button>
    </form>
</div>
