...
<div style="position:absolute;top:3%;width:100%;height:5%;z-index:9;text-align:right;right:5%"><form style="font-size:14px; font-weight: bold;" action="s.php" method="get"  target="_self" ><input name="keyword" type="text" style="width:100px;height:20px;font-size:12px;border:1px solid #aaa;padding:2px" value="<?php if(!$keyword){echo '封面名';} else{echo $keyword;}?>"/><button>搜索</button></form></div>
